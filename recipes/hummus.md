...
>   (that's baking powder). Same trap in German: **Natron**, not "Backpulver".
...
>   spice that will wreck the hummus.

> **Tahini naming:** widely sold under "tahini", but you may see **tahin**
...
5. **Build the tehina sauce:** whisk the **tahini** into the strained
   garlic-lemon liquid. It'll seize and thicken alarmingly — don't panic. Whisk
   in **ice water** (or reserved cooking liquid) a little at a time until it
   slackens into a pale, smooth, pourable sauce. Stir in the cumin and the
   remaining salt.
6. **Blend with the chickpeas:** set aside a handful of whole chickpeas for
   garnish. Add the warm chickpeas to the tehina sauce (or sauce to chickpeas in
   the processor) and blend until **very** smooth — run it a full 2–3 min longer
   than feels necessary; long blending is what makes it fluffy. Loosen with more
   ice water if stiff. Taste and adjust salt / lemon — it should taste slightly
   over-seasoned warm, since chilling mutes it.
